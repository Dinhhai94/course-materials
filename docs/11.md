...
There are 7 of them. 2 of them, we will not mention. For now, we will just focus on 3 of them: - `string`, `number`, and `boolean`.
...
## Dev Tools - Read, Evaluate, Print Loop (REPL)
